...
android {
    namespace = "com.seeker.drive"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.seeker.drive"
        minSdk = 34
...
dependencies {
    ...
    implementation(libs.androidx.material.icons.extended) // MDI 拓展
    ...
    implementation(libs.logging.interceptor) // 日志拦截器
